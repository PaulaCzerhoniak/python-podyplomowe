...
| **10:40 - 12:40** | Live coding: Klasy w praktyce | Pizza, Menu, Customer - SHOW → DO → REVIEW |
| **12:40 - 13:10** | **PRZERWA** | 30 minut |
| **13:10 - 15:00** | Dziedziczenie, wyjątki, I/O, testy | Zaawansowane koncepcje + projekt końcowy |

### Co zbudujemy dzisiaj?

Przepisanie aplikacji pizzerii na **programowanie obiektowe**:
- **Klasy podstawowe** - Pizza, Menu, Customer
- **Dziedziczenie** - VIPCustomer, CorporateCustomer
...
├── customer.py      # klasy: Customer, VIPCustomer, CustomerManager
├── order.py         # klasy: Order, OrderItem, OrderManager
├── exceptions.py    # własne wyjątki
├── persistence.py   # zapis/odczyt JSON
